...
#   If the value is undef or false, no management of the service will be
...
class nova::api (
  ...
  Optional[Variant[String[1],Boolean[false]]] $metadata_service_name = $nova::params::api_metadata_service_name,

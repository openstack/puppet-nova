  ...
  shared_examples 'novajoin authtoken' do
    ...
    context 'with default parameters' do
      ...
      it 'configure keystone_authtoken' do
        ...
        is_expected.to contain_novajoin_config('keystone_authtoken/memcache_secret_key').with_value('<SERVICE DEFAULT>').with_secret(true)
...
['memcached01:11211','memcached02:11211'],
      ...
      it 'configure keystone_authtoken' do
        ...
        is_expected.to contain_novajoin_config('keystone_authtoken/memcache_secret_key').with_value(params[:memcache_secret_key]).with_secret(true)
